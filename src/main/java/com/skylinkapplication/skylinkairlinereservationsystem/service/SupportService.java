...
public class SupportService {
	...
	public void createSampleTickets() {
		...
		if (users.size() >= 2) {
			...
			user1.setRole(Role.FREQUENT_TRAVELER);
		...
		ticket2.setIssueDescription(
				"My flight was delayed by 4 hours and I wasn't offered any compensation. " +
						"I would like to discuss possible reimbursement options.");
		ticket2.setStatus(SupportTicket.Status.RESOLVED);
		ticket2.setCreatedDate(new Date(System.currentTimeMillis() - 86_400_000L));
		...
		ticket3.setIssueDescription(
				"My luggage was lost during my connecting flight. " +
						"I've been waiting for updates for 3 days and haven't received any information.");
		ticket3.setStatus(SupportTicket.Status.OPEN);
		ticket3.setCreatedDate(new Date(System.currentTimeMillis() - 172_800_000L));
